...
__all__ = ['ResNet', 'cbam_resnet50', 'cbam_resnet101',]
...
def cbam_resnet50(in_channels,pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    print('Using CBAM-ResNet50 as backbone!')
...
def cbam_resnet101(in_channels,pretrained=False, **kwargs):
