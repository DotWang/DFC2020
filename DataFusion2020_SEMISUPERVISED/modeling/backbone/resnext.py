...
def resnext18(in_channels,**kwargs):
    """Constructs a ResNeXt-18 model.
    """
    model = ResNeXt(in_channels, BasicBlock, [2, 2, 2, 2], **kwargs)
    return model


def resnext34(in_channels,**kwargs):
    """Constructs a ResNeXt-34 model.
    """
    model = ResNeXt(in_channels, BasicBlock, [3, 4, 6, 3], **kwargs)
    return model


def resnext50(in_channels,**kwargs):
...
def resnext101(in_channels,**kwargs):
...
def resnext152(in_channels,**kwargs):
