...
def se_resnext_50(in_channels, **kwargs):
    """Constructs a ResNeXt-50 model.
    """
    print('Using SE-ResNeXt50 as backbone!')

    model = SE_ResNeXt(in_channels, Bottleneck, [3, 4, 6, 3], **kwargs)
    return model


def se_resnext_101(in_channels, **kwargs):
    """Constructs a ResNeXt-101 model.
    """
    model = SE_ResNeXt(in_channels, Bottleneck, [3, 4, 23, 3], **kwargs)
    return model


def se_resnext_152(in_channels, **kwargs):
    """Constructs a ResNeXt-152 model.
    """
    model = SE_ResNeXt(in_channels, Bottleneck, [3, 8, 36, 3], **kwargs)
    return model


if __name__ == "__main__":
    # import torch
    model = se_resnext_50(3)
    model.eval()
