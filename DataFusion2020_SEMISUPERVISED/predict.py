...
def main():
    ...
    # output dir
    parser.add_argument('--dir', type=str, default=None, help='folder of prediction of test dataset')
    ...
    if args.export == 'image':
        ...
        np.save(probdir + 'DFC2020_tes_' + str(args.model)+'_'+str(args.backbone)+'_'+str(args.batch_size)+'_.npy',pre_prob)
